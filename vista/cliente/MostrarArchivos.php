...
$ruta = "../../assest/dist/file/cliente/" . $nombrePersonal;
                    ...
                    <div class="card card-primary card-outline">
                        <div class="card-body box-profile">
                            <div class="text-center">
                                ...
                                if ($extension == "jpg" || $extension == "png" || $extension == "JPG" || $extension == "PNG" || $extension == "webp") {
                                ?>
                                    <img class="img-fluid button" src="<?php echo $ruta . "/" . $archivo; ?>" style="width:300px;">
                                <?php
                                } else {
                                ?>
                                    <img class="img-fluid" src="../../assest/dist/img/imgdefault.png" alt="User profile picture" style="width:300px;">
                            ...
                            ?>
                                <a href="<?php echo $ruta . "/" . $archivo; ?>" class="btn btn-info btn-block" target="_blank"><b>Visualizar</b></a>
                            ...
                            <button class="btn btn-danger btn-block" onclick="EliArchivo('<?php echo $archivo; ?>','<?php echo $nombrePersonal; ?>')">Eliminar</button>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: "POST",
                        data: obj,
                        url: "vista/cliente/EliArchivo.php?archivo=" + archivo + "&nombre=" + nombrePersonal,
